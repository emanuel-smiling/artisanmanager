...
package com.onezerothrice.artisan.events
{
	...
	public class ARtisanCameraEvent extends Event
	{
		public static const CAMERA_ALLOWED:String = "artisanCameraCameraAllowed";
		
		public var extraInfo:*;
		
		public function ARtisanCameraEvent(type:String, ei:* = null, bubbles:Boolean=false, cancelable:Boolean=false)
		{
			extraInfo = ei;
